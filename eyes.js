...
var DrawEye = function(eyecontainer, pupil, eyeposx, eyeposy, eyer){
  ...
  $(eyecontainer).css({position:'absolute', background:'#FFFFFF', 'border-radius': '50%'});
  ...
  $(window).mousemove(function(e){ 
    var d = {
      x: e.pageX - r - eyeposx - center.x - ($(document).width() / 2),
...
var eye = new DrawEye("eye1", "pupil1", 2, 8, 13);
var eye = new DrawEye("eye2", "pupil2", 25, 8, 13);